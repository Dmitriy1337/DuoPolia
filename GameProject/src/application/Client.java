...
public class Client extends Application {
	...
	public void start(Stage s) {
		...
		owner = new Label("city"); //им€ обьекта
		...
		profit = new Label("city"); //им€ обьекта
		...
		tcost = new Label("city"); //им€ обьекта
		...
		nres = new Label("city"); //им€ обьекта
